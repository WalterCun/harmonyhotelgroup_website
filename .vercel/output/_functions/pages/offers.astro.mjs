...
const $$Offers = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "lang": lang_es, "title": "Special Offers | Harmony Hotel Group" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="bg-primary-500/10 dark:bg-neutral-800 py-16"> <div class="container"> <h1 class="text-center mb-6">Special Offers</h1> <p class="text-center text-lg text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto">
...
}, "/home/runner/work/harmonyhotelgroup_website/harmonyhotelgroup_website/src/pages/offers.astro", void 0);

const $$file = "/home/runner/work/harmonyhotelgroup_website/harmonyhotelgroup_website/src/pages/offers.astro";
const $$url = "/offers";
